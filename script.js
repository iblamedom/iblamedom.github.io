...
(function initThree() {
    ...
    Promise.all([
        webgl.texture,                               
  webgl.loader.load('https://i.ibb.co/7thwS4S/domiintro.jpg'),
 ...
 webgl.loader.load('https://i.ibb.co/Z8jb7zk/21.jpg'),  
  ...
  webgl.texturesOptions = [
        ...
        { index: 1, texture: "image", quote: 'this is me', threshold: 60, random: 2.0, depth: 4.0, size: 2.5, maxDepth: 60, size: 1.5, square: 0},
      
    
    // quote: 'this is me', threshold: 60, random: 2.0, depth: 4.0, maxDepth: 60, size: 1.5, square: 0},
    
        { index: 4, texture: "image", quote: 'dont look <span style="color:#f4852a">back</span> <br>this is not the way you are going', threshold: 60, random: 2.0, depth: 4.0, maxDepth: 60, size: 1.5, square: 0},
      
    
        { index: 9, texture: "image", quote: 'Somethimes I pretend to be <span style="color:#C32B59">normal</span>. It usually doesnt work out.', threshold: 20, random: 2.0, depth: 8.0, size: 1.5, square: 0, a2: true },
        ...
        { index: 15, texture: "image", quote: 'dont take life <br> too seriously', threshold: 0, random: 2.0, depth: 3.0, maxDepth: 100, size: 1.5, square: 0, a5: true },
